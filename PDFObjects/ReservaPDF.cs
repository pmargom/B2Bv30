...
{
    public class ReservaPDF : Report
    {
        ...
        double posicionLinea = 90; //guardamos la altura de la siguiente línea de reserva 112-22
        ...
        private void datosPedido()
        {
            ...
            page_Cur.AddMM(9, 50, new RepString(propDatos, reserva.Referencia));//72-22
            page_Cur.AddMM(33, 50, new RepString(propDatos, "B2B"));
            page_Cur.AddCB_MM(56, 50, new RepString(propDatos, string.Format("{0} {1}", reserva.Fecha.Value.ToShortDateString(), reserva.Fecha.Value.ToShortTimeString())));
            page_Cur.AddMM(72, 50, new RepString(propDatos, reserva.Cliente.VC_CLIENTE));
        ...
        private void areaDatosPedido()
        {
            ...
            page_Cur.AddLT_MM(7, 55, new RepString(propPagina, "PÁGINA:")); //página y reserva 77-22

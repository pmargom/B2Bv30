...
{
    public class AlabaranPDF : Report
    {
        ...
        double posicionLinea = 90; //guardamos la altura de la siguiente línea de albaran 112-22
        ...
        private void datosFactura()
        {
            ...
            page_Cur.AddMM(9, 50, new RepString(propDatos, DatosAlbaranPDF.Tables[0].Rows[0]["VF_ALBARAN"].ToString())); //72-22
            ...
            page_Cur.AddMM(72, 50, new RepString(propDatos, DatosAlbaranPDF.Tables[0].Rows[0]["VC_CLIENTE"].ToString()));
        ...
        private void areaDatosFactura()
        {
            ...
            page_Cur.AddLT_MM(7, 55, new RepString(propPagina, "PÁGINA:")); //página y albaran 77-22

...
{
    public class oldPedidoPDF : Report
    {
        ...
        double posicionLinea = 112; //guardamos la altura de la siguiente línea de pedido
        ...
        private void datosPedido()
        {
            ...
            page_Cur.AddMM(9, 72, new RepString(propDatos, pedido.Referencia));
            page_Cur.AddMM(33, 72, new RepString(propDatos, "B2B"));
            page_Cur.AddCB_MM(56, 72, new RepString(propDatos, string.Format("{0} {1}", pedido.Fecha.Value.ToShortDateString(), pedido.Fecha.Value.ToShortTimeString())));
            page_Cur.AddMM(72, 72, new RepString(propDatos, pedido.Cliente.VC_CLIENTE));
        ...
        private void areaDatosPedido()
        {
            ...
            page_Cur.AddLT_MM(7, 77, new RepString(propPagina, "PÁGINA:")); //página y pedido
